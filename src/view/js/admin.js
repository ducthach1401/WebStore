...
async function getGoods() {
    ...
    if (data.message == 'Success') {
        ...
        for (let item of data.result){
            ...
            temp +=            '<div><a href="#" id="{}" class="btn btn-outline-info float-right" onclick="showModalRepair(this.id)">Thông tin</a></div>'.replace('{}', item._id);
            temp +=            '<div><a href="#" id="{}" class="btn btn-outline-info float-right" onclick="submitImage(this.id)">Ảnh</a></div>'.replace('{}', item._id);
